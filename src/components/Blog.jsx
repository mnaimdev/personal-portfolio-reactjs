                        ...
                        <div className="blog_left_sidebar">
                            <article className="blog_item">
                                ...
                                <div className="blog_details">
                                    <NavLink to="/blog-details" className="d-inline-block" >
                                        <h2>Google inks pact for new 35-storey office</h2>
                                    </NavLink>
                                    <p>That dominion stars lights dominion divide years for fourth have do not stars is that
