      ...
      <div className="col-xl-12">
        <div className="hero-cap">
          ...
          <nav aria-label="breadcrumb ">
            ...
            <li className="breadcrumb-item"><NavLink to="/blog-details">Blog Details</NavLink></li> 
            </ol>
          </nav>
        </div>
      </div>
            ...
            <div className="blog-author">
               <div className="media align-items-center">
                  ...
                  <div className="media-body">
                     ...
                     <p>Second divided from form fish beast made. Every of seas all gathered use saying you are, he
